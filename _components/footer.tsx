...
export default (data: Lume.Data, helpers: Lume.Helpers) => {
  return <>
    <footer className="flex mx-5 mb-5 pt-3 border-t border-slate-700 text-xs dark:text-slate-300">
      <div className="flex gap-2 items-center ml-3">
          <span className="w-3 h-3"><FontAwesomeIcon icon={faCopyright} /></span>2024<a href={data.github} className="dark:text-slate-400">{data.author}</a>
